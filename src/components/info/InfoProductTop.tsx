...
export default function InfoProductTop() {
  ...
  return (
    <div className="flex gap-[8px]">
      <div className="w-[100%] lg:w-[1002px] h-[356px] sm:h-[356px] flex items-center bg-[#76767629] backdrop-blur-[58px] rounded-[8px] border-b-[2px] sm:border-[0px] border-[#25272670] sm:shadow-none shadow-[inset_2px_4px_16px_2px_rgba(248,248,248,0.06)] justify-evenly">
        <Image
